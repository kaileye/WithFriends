                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="panel panel-default">
                            ...
                            <h4 class="text-center">Produce a list of item suggestions for a given customer (Based on common ad Types in customer history) </h4>
                            ...
                            <table class="table table-hover">
                               <thead>
                                ...
                                <tbody>
                                <c:forEach var="SearchItemResults" items="${recommendads}">
                                    <tr>
