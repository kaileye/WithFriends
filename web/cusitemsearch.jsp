                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="panel panel-default">
                            ...
                            <h4 class="text-center">Produce a list of all customers who have purchased a particular item</h4>
                            ...
                            <table class="table table-hover">
                               <thead>
                                ...
                                <tbody>
                                <c:forEach var="SearchItemCusResults" items="${SearchItemCusResults}">
                                    <tr>
                                        <td>${SearchItemCusResults.userId}</td>
                                        <td>${SearchItemCusResults.firstname}</td>
                                        <td>${SearchItemCusResults.lastname}</td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
