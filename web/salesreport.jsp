...
<html>
    ...
    <body>
        ...
        <c:if test="${managers.rowCount == 0}">
            ...
            <%-- Below = monthly sales report. results based off: 
                        session.setAttribute("saleresults", resultsales); 
                  in GetSalesReportServlet.java
            --%>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="panel panel-default">
                            ...
                            <h4 class="text-center">Monthly Sale - Search Results</h4>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                <c:forEach var="monthresult" items="${saleresults}">
                                    <tr>
                                        <td>${monthresult.transactionId}</td>
                                        <td>${monthresult.customerId}</td>
                                        <td>${monthresult.accountNumber}</td>
                                        <td>${monthresult.salesDateTime}</td>
                                        <td>${monthresult.adId}</td>
                                        <td>${monthresult.units}</td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
