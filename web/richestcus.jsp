                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="panel panel-default">
                            ...
                            <h4 class="text-center">Determine which customer generated most total revenue</h4>
                            ...
                            <table class="table table-hover">
                               <thead>
                                ...
                                <tbody>
                                <c:forEach var="richestcusresult" items="${RichestCusResults}">
                                    <tr>
                                        <td>${richestcusresult.userId}</td>
                                        <td>${richestcusresult.firstname}</td>
                                        <td>${richestcusresult.lastname}</td>
                                        <td>${richestcusresult.revenueGenerated}</td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
