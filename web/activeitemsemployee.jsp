                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="panel panel-default">
                            ...
                            <h4 class="text-center">Produce a list of most Best Selling items</h4>
                            ...
                            <table class="table table-hover">
                               <thead>
                                <tr>
                                    ...
                                    <th>Item Name</th>
                                    <th>Company</th>
                                    <th># of Sales containing this Item)</th>
                                </tr>
                                </thead>
                                <tbody>
                                <c:forEach var="ActiveItemResults" items="${ActiveItemResultsE}">
                                    <tr>
                                        <td>${ActiveItemResults.adId}</td>
                                        <td>${ActiveItemResults.type}</td>
                                        <td>${ActiveItemResults.itemName}</td>
                                        <td>${ActiveItemResults.company}</td>
                                         <td>${ActiveItemResults.activity}</td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
