                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="panel panel-default">
                            ...
                            <h4 class="text-center">All customers (and their emails) who have purchased from given company </h4>
                            ...
                            <table class="table table-hover">
                               <thead>
                                ...
                                <tbody>
                                <c:forEach var="companymailingResults" items="${companymailingResults}">
                                    <tr>
                                        <td>${companymailingResults.firstname}</td>
                                        <td>${companymailingResults.lastname}</td>
                                        <td>${companymailingResults.email}</td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
