                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="panel panel-default">
                            ...
                            <h4 class="text-center">Summary listing of transactions generated by a particular item, item type, or customer</h4>
                            ...
                            <table class="table table-hover">
                               <thead>
                                ...
                                <tbody>
                                <c:forEach var="salenameresult" items="${GenerateRevenueSearchResults}">
                                    <tr>
                                        ...
                                        <td>${salenameresult.adId}</td>
                                         ...
                                         <td>${salenameresult.adType}</td>
                                        <td>${salenameresult.firstName}</td>
                                        <td>${salenameresult.lastName}</td>
                                        <td>${salenameresult.units}</td>
                                        <td>${salenameresult.unitPrice}</td>
                                        <td>${salenameresult.sumOfSaleString}</td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                            <h4 class="text-center">Total revenue generated by a particular item, item type, or customer</h4>
                            ...
                            <table class="table table-hover">
                               <thead>
                                ...
                                <tbody>
                                <c:forEach var="salenameresulttotal" items="${GenerateRevenueSearchResultsTotal}">
                                    <tr>
                                        <td>${salenameresulttotal.columnTotal}</td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
